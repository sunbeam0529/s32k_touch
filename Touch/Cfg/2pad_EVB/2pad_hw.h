...
******************************************************************************/
	...
	#define ELEC0_ADC_CHANNEL     3         // Modify: Cext ADC channel
	#define ELEC0_PORT            PORTA     // Modify: Electrode and Cext PORT
	#define ELEC0_GPIO            PTA       // Modify: Electrode and Cext GPIO
	#define ELEC0_ELEC_GPIO_PIN   12        // Modify: Electrode GPIO pin
	#define ELEC0_CEXT_GPIO_PIN   7		   	// Modify: Cext GPIO pin
...
******************************************************************************/
	...
	#define ELEC2_ADC_CHANNEL     0
	#define ELEC2_PORT            PORTA
	#define ELEC2_GPIO            PTA
	#define ELEC2_ELEC_GPIO_PIN   13
	#define ELEC2_CEXT_GPIO_PIN   0
	...
	#define ELEC3_ADC_CHANNEL     5
	#define ELEC3_PORT            PORTB
	#define ELEC3_GPIO            PTB
	#define ELEC3_ELEC_GPIO_PIN   0
	#define ELEC3_CEXT_GPIO_PIN   1
	...
	#define ELEC6_ADC_CHANNEL     9
	#define ELEC6_PORT            PORTC
	#define ELEC6_GPIO            PTC
	#define ELEC6_ELEC_GPIO_PIN   16
