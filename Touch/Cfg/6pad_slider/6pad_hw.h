...
******************************************************************************/
// Number of touch button electrodes from 0 to 6
#define NUMBER_OF_BUTTON_ELECTRODES  6

/*******************************************************************************
* Modify: Enable or disable slider electrodes
******************************************************************************/
// YES or NO  for optional Slider electrodes
#define SLIDER_ENABLE 	YES
/*******************************************************************************
...
******************************************************************************/
#if SLIDER_ENABLE
// Default number of sliders
#define NUMBER_OF_SLIDERS 1
// Default number of slider electrodes per slider
#define NUMBER_OF_ELECTRODES_PER_SLIDER 2
// SW written for one slider only, consisting of 2 wedge electrodes!
#define NUMBER_OF_SLIDER_ELECTRODES  (NUMBER_OF_ELECTRODES_PER_SLIDER * NUMBER_OF_SLIDERS)
// Def or undef slider self guarding (possible only for slider consisting of 2 wedge electrodes)
//#define SLIDER_SELF_GUARDING
#else
...
/*******************************************************************************
* SLIDER ELECTRODES PIN CFG
******************************************************************************/
#if (NUMBER_OF_SLIDERS > 0)
/*******************************************************************************
* Modify: HW Slider Electrode 0 = electrode 6 defines, ON EVB REMOVE PULL UP:R712
******************************************************************************/
	#define ELEC6
...
******************************************************************************/
/*******************************************************************************
* Modify: Electrode 8 defines - wake up EGS (WILL INTERFERE WITH SBC BUT STILL WORKS)
******************************************************************************/
#if (NUMBER_OF_WAKEUP_ELECTRODES > 0)
	#define ELEC8
	#define ELEC8_ADC             ADC0
	#define ELEC8_ADC_CHANNEL     7
	#define ELEC8_PORT            PORTB
	#define ELEC8_GPIO            PTB
	#define ELEC8_ELEC_GPIO_PIN   13
	#define ELEC8_CEXT_GPIO_PIN   3
	#define ELEC8_PORT_MASK       (1 << ELEC8_ELEC_GPIO_PIN) | (1 << ELEC8_CEXT_GPIO_PIN)
	#define ELEC8_TRGMUX		  30
	#define ELEC8_DMAMUX		  42
	#define ELEC8_TYPE		  	  WAKEUP
#endif
